...
t = zeros(1,n+1) + 1; %Variable temporal
Mu = 18000000000; %Modulo de Corte en Pa

Ang = zeros(1,n+1); %Angulo entre dos camaras
...
d = linspace(0,10/1000); %Grosor de la camara 
...
%hold on;
t=t+0.1;
plot(d,Ang, 'LineWidth',2);
xlabel('Grosor');
ylabel('Angulo (Grados)');
grid on;
title 'Posicion Angular con Respecto al Grosor de Camara';
